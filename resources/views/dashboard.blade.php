...
<div class="min-h-screen bg-gray-100 dark:bg-gray-900 p-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 mb-10">
        ...
        <!-- CARD -->
        <div class="bg-gradient-to-r from-blue-500 to-blue-700 p-8 rounded-3xl shadow-xl text-white relative overflow-hidden">
        ...
        <!-- CARD -->
        <div class="bg-gradient-to-r from-green-500 to-green-700 p-8 rounded-3xl shadow-xl text-white relative overflow-hidden">
        ...
        <!-- CARD -->
        <div class="bg-gradient-to-r from-purple-500 to-purple-700 p-8 rounded-3xl shadow-xl text-white relative overflow-hidden">
        ...
        <!-- CARD -->
        <div class="bg-gradient-to-r from-red-500 to-red-700 p-8 rounded-3xl shadow-xl text-white relative overflow-hidden">
